import sys; sys.path.append('../../'); from prepare_for_lenscov import *; from params_here import *; Omega_S = 0.628318530718
...
covwriter_matrix(cov_l1l2_beyondLimber_mono, 'data_ssc_cov_l1l2_beyondLimber_mono_fsky_0.05_noderiv.dat')

...
#        R_1_l1 = zeros(len(chi_array))
#        R_1_l2 = zeros(len(chi_array))
#        R_K_l1 = zeros(len(chi_array))
#        R_K_l2 = zeros(len(chi_array))
#        Pnl_l1 = zeros(len(chi_array))
#        Pnl_l2 = zeros(len(chi_array))
#        for lll in range(len(chi_array)):
#            R_1_l1[lll] = R_1_int(z_array[lll], k1_now[lll])
#            R_1_l2[lll] = R_1_int(z_array[lll], k2_now[lll])
#            R_K_l1[lll] = R_K_int(z_array[lll], k1_now[lll])
#            R_K_l2[lll] = R_K_int(z_array[lll], k2_now[lll])
#            Pnl_l1[lll] = Pnl_int(z_array[lll], k1_now[lll])
#            Pnl_l2[lll] = Pnl_int(z_array[lll], k2_now[lll])
...
covwriter_matrix(cov_l1l2_A, 'data_store/data_ssc_cov_l1l2_A.dat')
covwriter_matrix(cov_l1l2_B, 'data_store/data_ssc_cov_l1l2_B.dat')
covwriter_matrix(cov_l1l2_C, 'data_store/data_ssc_cov_l1l2_C.dat')
covwriter_matrix(cov_l1l2_D, 'data_store/data_ssc_cov_l1l2_D.dat')
